...
import { DashboardNav } from "@/features/dashboard/componenets/dashboard-nav";
import { SidebarUserButton } from "@/features/dashboard/componenets/sidebar-user-button";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild size="lg" tooltip="ChaiCodeAIReview">
